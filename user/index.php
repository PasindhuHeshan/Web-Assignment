  ...
  <div class="wrapper">
    ...
    <div class="box box-solid">
        <div class="box box-primary">
            ...
            <div class="card mb-3">
                <div class="card-body">
                    <h5 class="card-title"><a href="view-job-post.php?id=<?php echo $row['id_jobpost']; ?>"><?php echo $row['jobtitle']; ?></a></h5>
                    <p class="card-text"><i class="fa fa-calendar"></i> <?php echo $row['createdat']; ?></p>
                    <div class="status">
                        <?php 
                        if($row['status'] == 0) {
