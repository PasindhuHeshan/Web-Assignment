...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="margin-left: 0px; padding-top: 10%">
  ...
  <footer class="footer" style="margin-left: 0px; width:100%; position:fixed; bottom: 0;">
    <div class="text-center">
      <strong> &copy;2024 CareerPlus.All rights reserved.</srtong>
    </div>
  </footer>
